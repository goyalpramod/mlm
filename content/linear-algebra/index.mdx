...
import { Vector } from '@/components/visualizations/linear-algebra/Vector'
...
If you are a true first principles thinker, you may question why we are doing this. I like the idea talked by Grant in this [video](https://www.youtube.com/watch?v=fNk_zzaMoSs&list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab&index=1&t=3s&ab_channel=3Blue1Brown)

If we think of adding two vectors, as moving in those directions. We can see that it is quite simple 
